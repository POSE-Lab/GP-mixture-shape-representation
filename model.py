...
class ExactGPModel(gpytorch.models.ExactGP):
    ...
    def __init__(
        self, train_x, train_y, likelihood, kernel=gpytorch.kernels.ScaleKernel(gpytorch.kernels.RQKernel())
    ):
    ...
    @classmethod
    def load_from_file(cls, file_path, kernel=gpytorch.kernels.RQKernel() ):
